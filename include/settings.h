...
//#define AHTXX_SENSOR               // add support for the AHT10, AHT15, AHT20 sensor family NOT SUPPORTED FOP ESP32 YET
...
const char mqtt_server[] = "192.168.0.54";    // MQTT server
const int mqtt_server_port = 1883;             // MQTT server port, default is 1883
const char mqtt_user[] = "basement";               // MQTT userid
const char mqtt_password[] = "";        // MQTT password
const char clientID[] = "growatt-basement";       // MQTT client ID
const char topicRootStart[] = "growatt-basement";      // MQTT root topic for the device, + client ID
